          ...
          <article className="format-audio">
            <div className="content-media">
              <div className="post-thumb">
                <img src={`${import.meta.env.BASE_URL}images/thumbs/single/single-02.jpg`} alt="Concert" />
                <div className="audio-wrap">
                  <audio controls style={{ width: '100%' }} id="player">
                    <source src={`${import.meta.env.BASE_URL}media/AirReview-Landmarks-02-ChasingCorporate.mp3`} type="audio/mpeg" />
            ...
            <div className="primary-content">
              ...
              <div className="entry-content">
                ...
                <p><img src={`${import.meta.env.BASE_URL}images/shutterbug.jpg`} alt="" /></p>
                <h2>Large Heading</h2>
              ...
              <div className="author-profile">
                <img src={`${import.meta.env.BASE_URL}images/avatars/user-05.jpg`} alt="" />
                <div className="about">
