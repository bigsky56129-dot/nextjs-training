            ...
            <article className="brick entry format-audio animate-this">
              <div className="entry-thumb">
                ...
                <div className="audio-wrap">
                  <audio id="player2" src={`${BASE}media/AirReview-Landmarks-02-ChasingCorporate.mp3`} width="100%" height="42" controls></audio>
                </div>
              </div>
              <div className="entry-text">
                <div className="entry-header">
        ...
        <div className="row">
          <nav className="pagination">
            ...
            <a
              href="#!"
              onClick={(e) => { e.preventDefault(); go(page + 1) }}
              className={`page-numbers next ${page === totalPages ? 'inactive' : ''}`}
            >
              Next
            </a>
          </nav>
