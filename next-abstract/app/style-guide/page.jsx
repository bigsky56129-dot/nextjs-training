    ...
    <section id="content-wrap" className="style-guide">
      ...
      <div className="row">
        <div className="col-six tab-full">
          ...
          <p>
            A <a href="#">link</a>, <abbr title="this really isn't a very good description">abbrebation</abbr>,
            <strong>strong text</strong>, <em>em text</em>, <del>deleted text</del>, and
            <mark>this is a mark text.</mark> <code>.code</code>
          </p>
        </div>
      ...
      <div className="row half-bottom">
        ...
        <div className="col-six tab-full">
          ...
          <h3>Buttons</h3>
          <p>
            <a className="button button-primary full-width" href="#">
              Primary Button
            </a>
            <a className="button full-width" href="#">
              Default Button
            </a>
          </p>
        </div>
